      ...
      <div className="relative overflow-hidden">
        ...
        <header className="relative z-10 flex justify-between items-center p-6 backdrop-blur-lg bg-black/40 border-b-2 border-purple-600/40 shadow-2xl shadow-purple-900/30">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-3xl font-bold bg-gradient-to-r from-slate-300 via-purple-400 via-violet-500 via-indigo-400 via-slate-300 via-purple-400 via-violet-500 to-indigo-400 bg-clip-text text-transparent animate-rgb-wave filter drop-shadow-lg">
              YESQUERS
            </h1>
          </div>
          <a
